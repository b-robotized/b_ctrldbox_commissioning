...
sleep 1
ros2 control set_hardware_component_state -c /b_controlled_box_cm fr3_left_FrankaHardwareInterface active
sleep 1
ros2 control set_hardware_component_state -c /b_controlled_box_cm fr3_right_FrankaHardwareInterface active
sleep 1
